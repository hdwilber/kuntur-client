...
export class RecordEditComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private mfService: MediaFileService, private restService: RestService, private rService: RecordService, private router: Router) {
